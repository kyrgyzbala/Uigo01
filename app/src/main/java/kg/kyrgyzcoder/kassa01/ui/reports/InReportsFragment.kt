...
class InReportsFragment : Fragment() {
    ...
    private var _binding: FragmentInRepostBinding? = null
    private val binding: FragmentInRepostBinding get() = _binding!!
    ...
    override fun onCreateView(
        ...
        _binding = FragmentInRepostBinding.inflate(inflater, container, false)
        return binding.root
    }
